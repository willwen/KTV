				...
				<form onSubmit={this.modifyOptions}>
					...
					<div className="checkbox">
						<span>
							<label>
								<input
									checked={this.state.wantScrolling}
									onChange={this.toggleScrolling}
									id="wantScrolling"
									type="checkbox"
								/>
								Scrolling
					...
					<div className="checkbox">
						<span>
							<label>
								<input
									checked={this.state.showLineNums}
									onChange={this.toggleLineNums}
									id="lineNumbers"
									type="checkbox"
								/>
								Line Numbers
					...
					<div className="checkbox">
						<span>
							<label>
								<input
									checked={this.state.showVisualizer}
									onChange={this.toggleVisualizer}
									id="visualizer"
									type="checkbox"
								/>
								Visualizer

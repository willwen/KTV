...
var _songBundle = require('./dist/song.bundle.js');

var _songBundle2 = _interopRequireDefault(_songBundle);
...
var index = fs.readFileSync(__dirname + '/webpage/song/index.html');
app.get('/song', function (req, res) {
	var id = xssfilters.inHTMLData(req.query.id); //just in case they send me some  garbage ID

	var html = (0, _server.renderToString)(_react2.default.createElement(_songBundle2.default, null));
...
app.get('/artists', function (req, res) {
	...
	MongoClient.connect(url, function (err, db) {
		if (err) console.log('unable to connect to server', err);else {
